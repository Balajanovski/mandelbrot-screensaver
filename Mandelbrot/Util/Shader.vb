...
Public Class Shader
    ...
    Public Sub New(vertexSrc As String, fragSrc As String)
        ...
        Dim vertexCode = ExportResource(Assembly.GetExecutingAssembly, "Mandelbrot", vertexSrc)
        ...
        ' Compile frag shader
        Dim fragCode = ExportResource(Assembly.GetExecutingAssembly, "Mandelbrot", fragSrc)
